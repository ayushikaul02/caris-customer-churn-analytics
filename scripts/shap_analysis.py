...
# ==================== PLOT 2: Bar Plot ====================
plt.figure(figsize=(10, 6))
shap.summary_plot(shap_values_class1, X_test, feature_names=available_features, show=False, plot_type="bar", plot_size=(10, 6))
...
feature_importance = pd.DataFrame({"Feature": available_features, "Importance": model.feature_importances_}).sort_values(
